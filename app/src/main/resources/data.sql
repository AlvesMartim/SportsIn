...
-- ============================================================
-- ARÈNES (6 stades répartis en France, coords GPS réelles)
-- equipe_controle : Monaco=2 arènes, PSG=2, OL=1, Nantes=1
-- ============================================================
INSERT OR IGNORE INTO arene (id, nom, latitude, longitude, equipe_controle) VALUES
  ...
  ('stade_francis_le_ble','Stade Francis Le Blé',   48.3988,  -4.4860, 1),
  ('velodrome',           'Stade Vélodrome',        43.2620,   5.3963, 2);
